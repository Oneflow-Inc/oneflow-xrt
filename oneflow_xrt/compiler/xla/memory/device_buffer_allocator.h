...
*/
#ifndef ONEFLOW_XRT_COMPILER_XLA_MEMORY_DEVICE_BUFFER_ALLOCATOR_H_
#define ONEFLOW_XRT_COMPILER_XLA_MEMORY_DEVICE_BUFFER_ALLOCATOR_H_
...
#endif  // ONEFLOW_XRT_COMPILER_XLA_MEMORY_DEVICE_BUFFER_ALLOCATOR_H_
