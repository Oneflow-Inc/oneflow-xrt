...
*/
#ifndef ONEFLOW_XRT_COMPILER_XLA_XLA_RESOURCE_MANAGER_H_
#define ONEFLOW_XRT_COMPILER_XLA_XLA_RESOURCE_MANAGER_H_
...
#endif  // ONEFLOW_XRT_COMPILER_XLA_XLA_RESOURCE_MANAGER_H_
