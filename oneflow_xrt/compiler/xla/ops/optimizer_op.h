...
*/
#ifndef ONEFLOW_XRT_COMPILER_XLA_OPS_OPTIMIZER_OP_H_
#define ONEFLOW_XRT_COMPILER_XLA_OPS_OPTIMIZER_OP_H_
...
#endif  // ONEFLOW_XRT_COMPILER_XLA_OPS_OPTIMIZER_OP_H_
