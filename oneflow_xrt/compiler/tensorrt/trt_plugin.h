...
*/
#ifndef ONEFLOW_XRT_COMPILER_TENSORRT_TRT_PLUGIN_H_
#define ONEFLOW_XRT_COMPILER_TENSORRT_TRT_PLUGIN_H_
...
class TrtPlugin : public nvinfer1::IPluginV2DynamicExt {
 public:
  ...
  virtual size_t getSerializationSize() const TRT_NOEXCEPT { return 0; }
...
#endif  // ONEFLOW_XRT_COMPILER_TENSORRT_TRT_PLUGIN_H_
