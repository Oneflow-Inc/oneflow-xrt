...
REGISTER_TRT_OP_KERNEL(broadcast_add,
                       BcastBinaryOp<nvinfer1::ElementWiseOperation::kSUM>)
    .EnableTrainPhase()
    .Finalize();
REGISTER_TRT_OP_KERNEL(broadcast_sub,
                       BcastBinaryOp<nvinfer1::ElementWiseOperation::kSUB>)
    .EnableTrainPhase()
    .Finalize();
REGISTER_TRT_OP_KERNEL(broadcast_mul,
                       BcastBinaryOp<nvinfer1::ElementWiseOperation::kPROD>)
    .EnableTrainPhase()
    .Finalize();
REGISTER_TRT_OP_KERNEL(broadcast_div,
                       BcastBinaryOp<nvinfer1::ElementWiseOperation::kDIV>)
    .EnableTrainPhase()
    .Finalize();
